...
func (s *DeviceService) GetAllDevices(ctx context.Context, limit int, offset int, sortByTitle bool, search string) (*[]models.Device, error) {
	devices, err := s.repo.GetAllDevices(ctx, limit, offset, sortByTitle, search)
	if err != nil {
